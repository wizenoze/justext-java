 ...
 */
public class JusTextStopWordsException extends JusTextException {

    /**
     * @see RuntimeException#RuntimeException()
     */
    public JusTextStopWordsException() {
        super();
    }
     ...
     */
    public JusTextStopWordsException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public JusTextStopWordsException(String message) {
        super(message);
    }
     ...
     */
    public JusTextStopWordsException(String message, Throwable cause) {
        super(message, cause);
    }
